...
class SurgeDetector:
    ...
    def __init__(self):
        ...
        # 임계값 설정 (⭐ v6.31.8-R2: 초단타 진입 조건 완화)
        self.threshold_1m = 1.2  # 1분 상승률 ≥ 1.2% (1.65% → 1.2% 완화)
        self.threshold_5m = 2.5  # 5분 상승률 ≥ 2.5% (3.3% → 2.5% 완화)
        self.threshold_15m = 4.0  # 15분 상승률 ≥ 4.0% (5.5% → 4.0% 완화)
        self.volume_ratio_threshold = 1.8  # 거래량 비율 ≥ 1.8 (2.2 → 1.8 완화)
        self.min_surge_score = 45  # 최소 급등 점수 (55 → 45 완화)
